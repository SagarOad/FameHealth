...
const LoginSignup = () => {
  return (
    ...
    >
    <div className='bg-[#114A8C] md:pl-20  sm:flex-wrap sm:flex sm:justify-between'>
        <div className='flex justify-between items-center py-2 px-4'>
        <span className="text-sm mr-8 text-white font-extralight">Follow Us</span>
        ...
        <div className='flex justify-between md:justify-items-start'>
            <button className='md:border-l-2 md:border-r-2 py-3 px-4'><AiOutlineShopping size={24} /></button>
            <div className='flex items-center justify-center text-white font-extralight font-[poppins] px-8'>
                <a className='mr-2'>Login</a> /
                <a className='ml-2'>Signup</a>
            </div>
        </div>
    </div>
    </IconContext.Provider>
